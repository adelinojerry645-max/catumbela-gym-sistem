...
import {
  ...
  PlayCircle, PauseCircle, MessageSquare, Send, ChevronRight, ScanLine, Clock, Printer,
} from "lucide-react";
...
function RegistoPonto({ contas, contaAtual, perfil, registosPonto, onRegistarPonto }) {
  ...
  const registosHoje = registosPonto.filter((r) => r.data === hojeStr).slice().reverse();
...
function RelatorioMensalEvolucao({ mesEscolhido, resumoMensal, membros, dadosGinasio, onFechar }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 overflow-y-auto print:bg-white print:static">
      <div className="max-w-2xl mx-auto bg-white my-4 rounded-2xl print:rounded-none print:my-0 p-6 text-slate-800">
...
function Relatorios({ membros, planos, produtos, pagamentosFeitos, acessos, contas, custos, vendasProdutos, movimentosCaixa, movimentosBancarios, dadosGinasio }) {
  // "Saldo inicial" é dinheiro que o ginásio já tinha antes de começar a
  ...
  const resumoMensal = useMemo(() => {
    ...
    // Evolução dos atletas — quantos existiam já no início do mês (inscritos
    // antes dele), e como estão distribuídos hoje entre ativos e vencidos,
    // para conseguires ver se o ginásio está a crescer ou a perder gente.
    const membrosAteInicioMes = membros.filter((m) => (m.dataInscricao || "9999") < mesEscolhido).length;
    const totalAteFimMes = membros.filter((m) => (m.dataInscricao || "9999") <= `${mesEscolhido}-31`).length;
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        ...
        <main className="flex-1 overflow-y-auto p-3 sm:p-6">
          ...
          {telaAtual === "relatorios" && perfil === "administrador" && (
            <Relatorios membros={membros} planos={planos} produtos={produtos} pagamentosFeitos={pagamentosFeitos} acessos={acessos} contas={contas} custos={custos} vendasProdutos={vendasProdutos} movimentosCaixa={movimentosCaixa} movimentosBancarios={movimentosBancarios} dadosGinasio={dadosGinasio} />
          )}
